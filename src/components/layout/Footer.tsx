	...
	return (
		<footer className="bg-charcoal text-gray-300 relative overflow-hidden">
			...
			<div className="absolute inset-0 opacity-5">
				<div className="absolute top-10 left-10 w-24 h-32 bg-gold rounded transform rotate-12"></div>
				<div className="absolute bottom-20 right-20 w-20 h-24 bg-burgundy rounded transform -rotate-12"></div>
				<div className="absolute top-1/2 left-1/4 text-6xl text-gold font-script">
					❝
				</div>
				<div className="absolute bottom-1/4 right-1/3 text-4xl text-burgundy">
					📚
				</div>
			</div>
			...
			<div className="relative z-10">
					...
					<div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
						...
						<div className="lg:col-span-1">
							...
							<p className="text-gray-400 mb-6 leading-relaxed">
								Nurturing literary excellence and critical thinking through
								comprehensive programs in English Studies, Literature, and
								Creative Writing since our establishment.
							</p>
							...
							<div className="space-y-3">
								...
								<div className="flex items-center space-x-3">
									...
									<p className="text-sm text-gray-300">info@aiesr.amity.edu</p>
								</div>
							</div>
						</div>
							...
							<div className="bg-gray-800 rounded-lg p-4">
								...
								<div className="flex flex-col space-y-2">
									<input
										...
										className="px-3 py-2 bg-gray-700 text-white rounded text-sm focus:outline-none focus:ring-2 focus:ring-gold"
									/>
						...
						<div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
							...
							<div className="text-center md:text-right">
								<p className="text-sm text-gray-400">
									© {currentYear} Amity Institute of English Studies and
				...
				<div className="bg-burgundy py-6">
					...
					<div className="container mx-auto px-4 text-center">
						...
						<cite className="text-gray-300 text-sm mt-2 block">
							— Steve Jobs
						</cite>
					</div>
				</div>
